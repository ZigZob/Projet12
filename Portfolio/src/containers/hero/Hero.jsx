    ...
    return (
        <section tabIndex="0" className="hero">
            ...
            <p className="hero__element hero__description">
                {lang === "en" ?
                    "As a web developer, I have enhanced my ability to break down complex problems into a multitude of simpler ones. As a gamer, I have grown to love understanding complex systems. As a deutan, I have always nurtured my unique perspective. As a devil's advocate, I have taken a liking to seeing the world through a different prism to get a better understanding of my surroundings."
                    : "En tant que développeur web, j'ai amélioré ma capacité à déstructurer des problèmes complexes en une multitude de problèmes simples. En tant que gamer, j'ai su apprécier la comprehension de systèmes complexes. En tant que deutéranope, j'ai depuis toujours cultivé ma différence de point de vue. En tant qu'avocat du diable, j'ai pu prendre plaisir à voir le monde sous un prisme différent du mien afin de mieux comprendre mon environnement."
                }
            </p>
        </section>
    )
